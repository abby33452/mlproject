...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        Returns:
        - preprocessor (ColumnTransformer): A pipeline that handles both numerical and categorical data.
        """
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        Reads the train and test datasets, applies the preprocessing pipeline, and saves the preprocessor object.
        ...
        Returns:
        - train_arr (np.ndarray): Transformed train data.
